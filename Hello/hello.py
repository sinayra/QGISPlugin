...
class Hello:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Hello', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Hello/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Message'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = HelloDockWidget()
